          ...
          <div className={styles.info}>
                ...
                <div className={styles.details}>
                    ...
                    <div className={styles.otherInfo}>
                        ...
                        <div className={styles.column}>
                            ...
                            <div className={styles.fieldContent}>{film.services.cast ? film.services.cast.map(x=><div>{x}</div>).slice(0, 3):'---'}</div>
                            </div>
                        </div>
            ...
            <div className={styles.reviews}>
              <div className={styles.review}>
                {film.reviews.length === 0 ? <div className={styles.noReview}>No reviews available</div> :
